...
void ImGui::ShowDemoWindow(bool* p_open)
{
    ...
    if (!ImGui::Begin("Dear ImGui Demo", false, p_open, window_flags))
    {
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            ImGui::Begin("Horizontal contents size demo window", false, &show_horizontal_contents_size_demo_window, show_h_scrollbar ? ImGuiWindowFlags_HorizontalScrollbar : 0);
...
{
    if (!ImGui::Begin("About Dear ImGui", false, p_open, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
...
static void ShowExampleAppLayout(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple layout", false, p_open, ImGuiWindowFlags_MenuBar))
    {
        if (ImGui::BeginMenuBar())
        {
            if (ImGui::BeginMenu("File"))
...
static void ShowExampleAppAutoResize(bool* p_open)
{
    if (!ImGui::Begin("Example: Auto-resizing window", false, p_open, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
...
static void ShowExampleAppConstrainedResize(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Constrained Resize", false, p_open, flags))
    {
...
static void ShowExampleAppSimpleOverlay(bool* p_open)
{
    ...
    if (ImGui::Begin("Example: Simple overlay", false, p_open, window_flags))
    {
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    bool window_contents_visible = ImGui::Begin("Example: Documents", false, p_open, ImGuiWindowFlags_MenuBar);
