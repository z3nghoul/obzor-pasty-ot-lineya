...
#define SECURE_HASH(txt) ~CONSTANT(hash::fnv1a::ct(txt))
#define SECURE_HASH_RT(txt) hash::fnv1a::rt(txt)
#define SECURE_HASH_BUFFER(buff, size) hash::fnv1a::rt_buffer(buff, size)